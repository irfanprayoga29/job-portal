            ...
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">
                        <h4><i class="bi bi-pencil"></i> Edit Resume</h4>
                    </div>
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('resumes.update', $resume) }}" method="POST" enctype="multipart/form-data" id="resumeForm">
                            ...
                            <!-- Current File Info -->
                            <div class="mb-4">
                                <label class="form-label fw-bold">Current Resume File</label>
                                <div class="current-file">
                                    <div class="d-flex align-items-center">
                                        <i class="bi bi-file-earmark-{{ $resume->file_type == 'pdf' ? 'pdf' : 'text' }} me-3" style="font-size: 2rem; color: {{ $resume->file_type == 'pdf' ? '#dc3545' : '#0d6efd' }};"></i>
                                        <div class="flex-grow-1">
                                            <h6 class="mb-1">{{ $resume->file_name }}</h6>
                                            <small class="text-muted">
                                                {{ $resume->formatted_file_size }} • 
                                                Uploaded {{ $resume->created_at->format('M d, Y') }}
                                            </small>
                                        </div>
                            ...
                            <div class="mb-4">
                                <label class="form-label fw-bold">Replace Resume File (Optional)</label>
                                <div class="upload-area" onclick="document.getElementById('resume_file').click()">
                                    <div class="upload-icon">
                                        <i class="bi bi-cloud-upload"></i>
                                    </div>
                                    <h6>Click to upload new file</h6>
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="description" id="description" class="form-control" rows="3" 
                                          placeholder="Brief description of this resume">{{ old('description', $resume->description) }}</textarea>
                                <small class="text-muted">This helps you identify different versions of your resume.</small>
                                @error('description')
                            ...
                            <div class="mb-4">
                                ...
                                <small class="text-muted">Active resume will be used for job applications. Only one resume can be active at a time.</small>
                            </div>
                            ...
                            <div class="d-flex justify-content-between">
                                ...
                                <button type="submit" class="btn btn-primary">
                                    <i class="bi bi-check-lg"></i> Update Resume
                                </button>
                            </div>
                        </form>
                    </div>
