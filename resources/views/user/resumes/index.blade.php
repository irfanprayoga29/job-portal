        ...
        <div class="container">
            <div class="row">
                <div class="col-12 text-center">
                    <h1 class="fw-bold mb-3">My Resumes</h1>
                    <p class="lead mb-0">Track your resumes</p>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="col-12">
                        ...
                        <div class="resume-card {{ $resume->is_active ? 'active' : '' }}">
                            <div class="row align-items-center">
                                <div class="col-md-1 text-center">
                                    <i
                                        class="bi bi-file-earmark-{{ $resume->file_type == 'pdf' ? 'pdf' : 'text' }} file-icon {{ $resume->file_type }}"></i>
                                </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <p class="text-muted mb-1">
                                        {{ $resume->description ?: 'No description provided' }}</p>
                                    <div class="file-size">
                                ...
                                <div class="col-md-5 text-end">
                                    <div class="btn-group" role="group">
                                        ...
                                        @if (!$resume->is_active)
                                            <form action="{{ route('resumes.set-active', $resume) }}" method="POST"
                                                class="d-inline">
                                                @csrf
                                                @method('PATCH')
                ...
                @else
                    <div class="text-center py-5">
                        ...
                        <p class="text-muted">Upload your first resume to get started with job applications.
                        </p>
                        <a href="{{ route('resumes.create') }}" class="btn btn-primary">
                ...
                @if ($resumes->where('is_active', true)->count() == 0 && $resumes->count() > 0)
                    <div class="alert alert-warning mt-3">
                        ...
                        <strong>No Active Resume:</strong> Please set one of your resumes as active to apply
                        for
                        jobs.
                    </div>
                @endif
