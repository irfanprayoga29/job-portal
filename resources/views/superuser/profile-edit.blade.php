        ...
        <div class="mx-5">
          ...
          <div class="section-card">
            <ul class="tab-list nav flex-column" id="navTabs">
              <li class="nav-item">
                <a class="nav-link active" href="#basic-info"
                  >Basic Information</a
                >
              </li>
              <li class="nav-item">
              ...
              <li class="nav-item">
                <a class="nav-link" href="#company-description"
                  ...
                  <div class="upload-logo mb-3">
                    ...
                    <div>
                      ...
                      <small class="text-muted"
                        >Format: .jpg, .jpeg, .png | Size: 120px x 120px</small
                      >
                    </div>
                  </div>
