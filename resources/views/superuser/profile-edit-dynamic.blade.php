                        ...
                        <form action="{{ route('superuser.profile.update') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <section id="basic-info">
                                ...
                                <div class="upload-logo mb-4">
                                    ...
                                    @else
                                        <img src="{{ url('/front-end/img/default-logo.png') }}" alt="Default Logo" 
                                    ...
                                    @endif
                                    <div>
                                        <input type="file" name="company_logo" id="company_logo" class="d-none" accept=".jpg,.jpeg,.png">
                                        <button type="button" class="btn btn-primary-custom btn-sm" onclick="document.getElementById('company_logo').click()">
                                            UPLOAD LOGO
                                        </button><br />
                                        <small class="text-muted">Format: .jpg, .jpeg, .png | Recommended: 120px x 120px</small>
                                        @error('company_logo')
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="address" class="form-control" rows="3" 
                                              placeholder="Enter complete office address...">{{ old('address', $user->address) }}</textarea>
                                    @error('address')
                                        <div class="text-danger small">{{ $message }}</div>
                                    @enderror
                                </div>
                            ...
                            <section id="company-description" class="mt-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    @error('company_description')
                                        <div class="text-danger small">{{ $message }}</div>
                                    @enderror
                                    <small class="text-muted">This description will be visible to job applicants on your job postings.</small>
                                </div>
                            </section>
