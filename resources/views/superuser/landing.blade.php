...
<body>
    ...
    @if (Auth::check() && Auth::user()->role_id == 2)
        ...
        <div class="">
            ...
            <img src="{{ url(Auth::user()->company_banner) }}" alt="Company Banner" class="object-fit-cover"
                            ...
                            <div class="row no-gutters align-items-center">
                                <div class="col mx-2">
                                    ...
                                    <p class="card-text">
                                        ...
                                        {{ \Carbon\Carbon::parse(Auth::user()->date_of_birth)->format('Y') }}<br>
                                        <strong>Address:</strong> {{ Auth::user()->address }}
                                    </p>
                                </div>
                                <div class="col-auto">
                                    <img src="{{ url(Auth::user()->company_logo) }}" alt="Company Logo"
                                ...
                                <div class="col-12">
                                    ...
                                    <div class="d-flex gap-3 flex-wrap">
                                        ...
                                        <a href="#" class="btn btn-outline-secondary">
                                            <i class="bi bi-people"></i> View Applicant
                                        </a>
                                ...
                                <div class="row mt-4">
                                    <div class="col-12">
                                                ...
                                                <tbody>
                                                    @foreach ($recentApplications as $application)
                                                        <tr>
                                                            ...
                                                            <td>{{ $application->date_submitted->format('M d, Y') }}
                                                            </td>
                                                            <td>
                                        ...
                                        <div class="text-center mt-3">
                                            <a href="{{ route('superuser.jobs.index') }}"
